...
public class arrayManipulator11 {
    ...
    static void findLastOdd(String[] inputAsArray, String token){
    ...
    static  void findLastEven(String [] inputAsArray,String token){
        int neededCount = Integer.parseInt(token);
        if (neededCount > inputAsArray.length){
            System.out.println("Invalid count");
        }else {
    ...
    static void findFirstOdd(String[] inputAsArray,String token){
        int neededCount = Integer.parseInt(token);
        if (neededCount>inputAsArray.length){
            System.out.println("Invalid count");
        }else{
    ...
    static void findFirstEven(String[] inputAsArray, String token){
        int neededCount = Integer.parseInt(token);
        if (neededCount > inputAsArray.length){
            System.out.println("Invalid count");
        }else {
    ...
    static  void getMinOdd (String[] inputAsArray){
    ...
    static  void getMinEven (String[] inputAsArray){
        int minElement = Integer.MAX_VALUE;
        int indexOfElement = -1;
        for (int i = 0; i <= inputAsArray.length-1 ; i++) {
            if (Integer.parseInt(inputAsArray[i]) % 2 == 0){
    ...
    static void getMaxEven (String [] inputAsArray){
    ...
    static void getMaxOdd (String[] inputAsArray){
        int maxElement = Integer.MIN_VALUE;
        int indexOfMaxElement = -1;
        for (int i = 0; i <=inputAsArray.length-1 ; i++) {
            if (Integer.parseInt(inputAsArray[i]) % 2 != 0){
    ...
    static String [] getNewArray (String[] inputAsArray, String token){
